...
void main() {
  group('ZigZag Indicator', () {
    ...
    test('ZigZagIndicator calculates the correct results', () {
      ...
      expect(indicator.getValue(4).quote, 65.55);
      expect(indicator.getValue(5).quote, 63.19);
      expect(indicator.getValue(6).quote.isNaN, true);
      expect(indicator.getValue(8).quote, 62.15);
    });
  });
}
