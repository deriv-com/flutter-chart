...
void main() {
  group('BarrierObject', () {
    test('Barrier with epoch values isOnEpochRange and isOnValueRange', () {
      const BarrierObject barrierObject = BarrierObject(10, 20, 10.2);
    ...
    test('Horizontal Barrier without epoch isOnEpochRange and isOnValueRange',
        () {
      const BarrierObject hBarrierObject = BarrierObject(null, null, 10.2);
    ...
    test('Vertical Barrier isOnEpochRange and isOnValueRange', () {
      const BarrierObject barrierObject = VerticalBarrierObject(10, null);
