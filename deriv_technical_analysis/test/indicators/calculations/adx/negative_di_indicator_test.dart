...
void main() {
  ...
  setUpAll(() {
    ticks = const <MockTick>[
      ...
      MockOHLC(21, null, 46.65, 46.74, 45.94),
      MockOHLC(22, null, 46.97, 47.08, 46.68),
      MockOHLC(23, null, 46.56, 46.64, 46.17),
      MockOHLC(24, null, 45.29, 45.81, 45.10),
      MockOHLC(25, null, 44.94, 45.13, 44.35),
      MockOHLC(26, null, 44.62, 44.96, 44.61),
      MockOHLC(27, null, 44.70, 45.01, 44.20),
      MockOHLC(28, null, 45.27, 45.67, 44.93),
      MockOHLC(29, null, 45.44, 45.71, 45.01),
      MockOHLC(30, null, 44.76, 45.35, 44.46),
    ];
  });

  group('Negative DI Indicator test.', () {
    test(
