...
///
/// This function is meant for external usage, to choose initial granularity for contract details.
///
/// Default scale is used.
/// Default scale means each interval (in other words candle) is [XAxisModel.defaultIntervalWidth] pixels in width.
///
