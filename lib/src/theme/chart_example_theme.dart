...
/// app. Through an instance of the [ChartExampleTheme] class, it is possible to
/// access font family, various app colors, update app theme, and get text style
class ChartExampleTheme extends ChartTheme {
  factory ChartExampleTheme() => _instance;

  ChartExampleTheme._internal();

  static final ChartExampleTheme _instance = ChartExampleTheme._internal();
