...
//   /// @since 6.0.0
//
//   static void restoreDefaultConfig({dynamic stx, String? toolName, bool? all}) {
//     if (all)
...
//
//   void updateSource(
//       {dynamic stx, String? name, String? newName, String? newPanel}) {
//     if (!name) return;
...
//   /// @since 3.0.0
//
//   void copyConfig({bool? withPreferences}) {
//     Drawing._copyConfig(
//         drawingInstance: this, withPreferences: withPreferences);
//   }
//
...
//
//   static void _copyConfig({Drawing? drawingInstance, bool? withPreferences}) {
...
//   /// @memberof CIQ.Drawing
//
//   dynamic click({dynamic context, num? tick, num? value}) {
...
//   /// @memberOf CIQ.Drawing
//
//   void move({dynamic context, num? tick, num? value}) {
...
//
//   void reposition(
//       {dynamic context, dynamic repositioner, num? tick, num? value}) {}
//
...
//   /// @memberof CIQ.Drawing
//
//   void intersected({num? tick, num? value, dynamic box}) {
...
//
//   /// draw littleCircle
//   void littleCircle({dynamic ctx, num? x, num? y, bool? fill}) {
//     if (permanent) return;
...
//
//   /// rotate
//   void rotator({dynamic ctx, num? x, num? y, bool? on}) {
//     if (permanent) return;
...
//
//   /// move
//   void mover({dynamic ctx, num? x, num? y, bool? on}) {
//     if (permanent) return;
//     var circleSize = this.littleCircleRadius();
//     var strokeColor = this.stx.defaultColor;
//     var length = 5;
...
//
//   /// resize
//   void resizer({dynamic ctx, num? x, num? y, bool? on}) {
//     if (permanent) return;
//     var circleSize = this.littleCircleRadius();
//     var strokeColor = this.stx.defaultColor;
