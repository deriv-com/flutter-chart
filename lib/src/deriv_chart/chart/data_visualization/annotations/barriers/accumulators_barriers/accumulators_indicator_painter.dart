...
class AccumulatorClosedIndicatorPainter
    extends SeriesPainter<AccumulatorClosedIndicator> {
  /// Initializes [AccumulatorIndicatorPainter].
  ...
  void onPaint({
    ...
    final AccumulatorClosedIndicator indicator = series;
    ...
    final double tickX = epochToX(indicator.tick.epoch);
    final double tickQuote = indicator.tick.quote;
