...
class VerticalLineAddingPreviewMobile
  ...
  bool hitTest(Offset offset, EpochToX epochToX, QuoteToY quoteToY) {
    ...
    // For vertical line when we're adding it, we only need to check if the
    // point is near the line's x-coordinate, because it shows the label during
  ...
  @override
  String get id => 'Vertical-line-adding-preview-mobile';
  ...
  void paintOverYAxis(
    ...
    // Vertical line doesn't paint over Y-axis
  }
