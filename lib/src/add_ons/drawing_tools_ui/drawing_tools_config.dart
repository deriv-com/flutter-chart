...
import 'drawing_tools_item.dart';
...
/// Indicator config
@immutable
abstract class DrawingToolsConfig {
  /// Initializes
  ...
  factory DrawingToolsConfig.fromJson(Map<String, dynamic> json) {
